...
// The following constant specifies the degree of the tree
...
class BTreeFile
{
	public:
		...
		// Constructor - parameter has the same meaning as for the BTree
		// constructor.	 This actually creates the access path to the
		// file
		...
		// number of some IO system error.)
	...
	private:
		...
		BlockNumber _lastUsed;			// Number of the last block
										//	currently in use
		BlockNumber _free;				// Pointer to a linked list 
										//	of recycled blocks
		FILE * _stream;					// The stdio stream actually
										//	used
